...
const updateDB = async () => {
    try {
        ...
        oracledb.initOracleClient({ libDir: 'C:/Users/pesyas/Downloads/instantclient-basic-windows.x64-21.12.0.0.0dbru/instantclient_21_12' });
        ...
        const data = fs.readFileSync('../yadSara/inputFiles/yadSara.ejs', 'utf-8');
